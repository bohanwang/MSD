...
int MedialAxisRepresentation::TetGenUtilities::computeVoronoiDiagram(const std::vector<VegaFEM::EigenSupport::V3d> &points, VoronoiDiagram &vd)
{
...
int MedialAxisRepresentation::TetGenUtilities::computeTetMesh(const TriMeshGeo &mesh, const std::string &switcher, VegaFEM::EigenSupport::MXd &vtx, VegaFEM::EigenSupport::MXi &tet)
{
  // assign vertices;
